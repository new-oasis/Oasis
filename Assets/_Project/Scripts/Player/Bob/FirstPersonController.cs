...
namespace Oasis
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void OnLook(Vector2 _input)
		{
			...
			_cinemachineTargetPitch -= _input.y * RotationSpeed * deltaTimeMultiplier;
			_rotationVelocity = _input.x * RotationSpeed * deltaTimeMultiplier;
		...
		private void Jump()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (inputReader.jump && _jumpTimeoutDelta <= 0.0f)
