...
namespace Oasis.Bob
{
    ...
    public class BobActions : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            inputReader.Place += Place;
            inputReader.RemoveStart += RemoveStart;
            inputReader.RemoveEnd += RemoveEnd;
        }
        ...
        {
            Debug.Log("PlaceBlock start " + screenPoint.ToString());
        ...
        public void RemoveStart(Vector2 screenPoint)
        {
