...
//                     
//                     
//                     // Get voxels DynamicBuffer 
//                     var w = Unity.Entities.World.DefaultGameObjectInjectionWorld;
//                     var em = Unity.Entities.World.DefaultGameObjectInjectionWorld.EntityManager;
//                     var worldQuery = em.CreateEntityQuery(typeof(Oasis.World.World));
//                     if (worldQuery.CalculateEntityCount() == 0)
//                         Debug.LogError("World not found");
//                     var world = worldQuery.GetSingleton<Oasis.World.World>();
//                     var worldEntity = worldQuery.GetSingletonEntity();
//
//                     // Get world BlockStateElements
//                     var blockStateElements = em.GetBuffer<BlockStateReference>(worldEntity);
//                     BlockState blockState = em.GetComponentData<BlockState>(blockStateElements[voxel].Value);
//                     BlockState otherBlockState = em.GetComponentData<BlockState>(blockStateElements[adjacentVoxel].Value);
...
//                         
//                         // Get Model
//                         Model model = em.GetComponentData<Model>(blockState.Model);
//                         
//                         var modelFaces = model.ModelElements[0].ModelFaces;
//                         var modelFace = modelFaces.FirstOrDefault(mf => mf.Side == (Side) side);
