...
namespace Oasis.Game.World
{
    public class World : MonoBehaviour
    {
        ...
        public Oasis.ECS.World.World world;
        ...
        private void Start()
        {
            ...
            worldEntity = em.CreateEntityQuery(typeof(Oasis.ECS.World.World)).GetSingletonEntity();
            world = em.GetComponentData<Oasis.ECS.World.World>(worldEntity);
